    ...
    <div className='min-h-screen relative overflow-hidden bg-black pt-10'>
      ...
      <div className='container max-w-[1400px] mx-auto px-4 min-h-screen relative'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-screen'>
          {/* Left Content */}
          <div className='z-10 pt-32'> {/* Increased padding-top to account for fixed navbar */}
            {/* Discount Badge */}
            ...
            <div className='relative'>
              <h1 className='text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-snug mb-8 font-manrope'>
                THE NEXT
                <br />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className='absolute -top-5 right-0 group w-36 h-36 rounded-full'
              >
