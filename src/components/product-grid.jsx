    ...
    >
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="text-4xl font-bold text-white tracking-wider">EXPLORE PRODUCTS</p>
        </motion.div>
                ...
                <div className="relative z-10 p-[1px] rounded-xl">
                  <div className="bg-[#0E0E0E] rounded-xl p-3">
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
                      <div className="bg-orange text-black font-bold text-sm px-4 py-1">from {product.basePrice}$</div>
                    </div>
                    ...
                    <div className="mt-4 space-y-4">
                      <h4 className="text-2xl text-white uppercase font-extrabold">{product.name}</h4>
