          ...
          <div className='flex flex-col gap-10 md:gap-14 max-w-2xl w-full items-end  mt-8 md:mt-0'>
            ...
            <div className='flex justify-start items-center gap-4 max-w-2xl md:gap-5'>
              ...
              >
                ...
                />
                <path
                  d='M44.0683 15.9021C43.243 15.1063 42.0215 14.8099 40.8826 15.1219L14.3232 22.3773C13.1215 22.6909 12.2698 23.5912 12.0403 24.7349C11.8059 25.8988 12.6246 27.3765 13.6943 27.9943L21.9989 32.7891C22.8506 33.2805 23.9499 33.1573 24.6548 32.4895L34.1643 23.5007C34.643 23.0326 35.4353 23.0326 35.914 23.5007C36.3927 23.9531 36.3927 24.6865 35.914 25.1545L26.388 34.1449C25.6815 34.8112 25.5495 35.8488 26.0694 36.6539L31.1436 44.5333C31.7378 45.4695 32.7612 46 33.8837 46C34.0157 46 34.1643 46 34.2963 45.9844C35.5839 45.8283 36.6074 45.0014 36.987 43.8312L44.8607 18.9134C45.2074 17.8524 44.8938 16.6978 44.0683 15.9021Z'
                  fill='#E39530'
                />
              </svg>
